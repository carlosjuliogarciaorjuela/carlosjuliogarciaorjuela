...
export const metadata: Metadata = {
  ...
  description: "Soluciones KyJ es una empresa líder en la construcción de obras civiles en Colombia. Ofrecemos proyectos de infraestructura, edificación y urbanismo con calidad y seguridad.",
    keywords: [
        "Soluciones KyJ",
